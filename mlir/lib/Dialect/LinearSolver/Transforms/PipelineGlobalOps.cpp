...
#define GEN_PASS_DEF_LINEARSOLVERPIPELINEGLOBALS
#include "mlir/Dialect/LinearSolver/Transforms/Passes.h.inc"

namespace {

class LinearSolverPipelineGlobals
    : public impl::LinearSolverPipelineGlobalsBase<LinearSolverPipelineGlobals> {
public:
...
// Builds map from a symbol to LinearSolver global symbols loaded or stored
// during processing.
LogicalResult LinearSolverPipelineGlobals::buildGlobalMap(ModuleOp module) {
...
void LinearSolverPipelineGlobals::processBlock(
...
void LinearSolverPipelineGlobals::runOnOperation() {
...
createLinearSolverPipelineGlobalsPass() {
  return std::make_unique<LinearSolverPipelineGlobals>();
}
