...
mlirGetDialectPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "LinearSolver", LLVM_VERSION_STRING,
...
extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo mlirGetPassPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "LinearSolverPasses", LLVM_VERSION_STRING,
          []() { mlir::linearsolver::registerPasses(); }};
}
